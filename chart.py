...
class FDFrame(QWidget):
    def __init__(self):
        ...
        for idx, (hname, price_str, price, vol) in enumerate(data):
            ...
            item = FDQTableWidgetItemCheckBox()

            self.table.setItem(idx, 0, item)
            chbox = FDCheckBox(item)
...
class FDQTableWidgetItemCheckBox(QTableWidgetItem):
    """
...
if __name__ == '__main__':
    ...
    frame.resize(600, 200)  # width, height
    frame.show()
